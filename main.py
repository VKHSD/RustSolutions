...
async def quarry(ctx, multi: float = 3, diesel: int = 1):
    ...
    quarry_output += f"{ceil(100 * diesel * multi)} hqm or {ceil(1500 * diesel * multi)} stone at quarry"
    ...
    excavator_output += f"{ceil(200 * diesel * multi)} hqm or {ceil(3000 * diesel * multi)} stone at excavator"
